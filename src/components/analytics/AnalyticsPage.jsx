              ...
              <div className="analytics-grid-2" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem' }}>
                {bySide.map(r => (
                  <div key={r.side} style={{
                    ...
                    border: `1px solid ${r.side === 'Buy' ? 'rgba(var(--accent-lime-rgb), 0.35)' : 'rgba(var(--color-loss-rgb), 0.35)'}`,
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            ...
            <div className="analytics-grid-4" style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '1rem' }}>
              {[
                ...
                <div key={label} style={{
                  background: 'var(--bg-card)',
                  border: `1px solid ${value > 0 ? (positive ? 'rgba(var(--accent-lime-rgb), 0.28)' : 'rgba(var(--color-loss-rgb), 0.28)') : 'var(--border-color)'}`,
                  borderRadius: 'var(--radius-md)',
                  padding: '16px 20px',
                }}>
...
function Callout({ label, value, sub, positive }) {
  return (
    <div style={{
      background: 'var(--bg-main)',
      border: `1px solid ${positive ? 'rgba(var(--accent-lime-rgb), 0.28)' : 'rgba(var(--color-loss-rgb), 0.28)'}`,
      borderRadius: '10px',
      padding: '12px 16px',
      flex: 1,
    }}>
